...
// Source: ordering-api/internal/database/models (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -package mockdb -destination internal/database/mock/store.go ordering-api/internal/database/models Store
//
...
import (
	context "context"
	db "ordering-api/internal/database/models"
	reflect "reflect"
